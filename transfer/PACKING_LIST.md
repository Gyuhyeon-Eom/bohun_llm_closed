...
| ☐ | **exaone3.5 LLM 모델** | 직링크 없음 — 온라인 PC에 Ollama 설치 후 `ollama pull exaone3.5:7.8b` → `~/.ollama/models` 폴더 통째 복사 | 4.8GB |
...
| ☐ | **Ollama 리눅스 본체** | https://ollama.com/download/ollama-linux-amd64.tgz | ~1GB |
...
| ☐ | **Ollama 윈도우** (개발 PC에서 LLM 돌릴 경우) | https://ollama.com/download/OllamaSetup.exe | ~700MB |
